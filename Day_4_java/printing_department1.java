...
class printing_department1{
    ...
    public static void main(String args[]) {
        ...
        //Do the check_removable for each position. Also find the neighbours for each position.
        int available_rools_count = 0;
        for (int line_index = 0; line_index < grid.length; line_index++) {
            ...
            for (int pos_index = 0; pos_index < line.length; pos_index++) {
                ...
                if (curr_pos.check_removable(neighbours)) {
                    available_rools_count++;
                }
            }
        }
        System.out.println("Number of available rolls: " + available_rools_count);
    }
}
